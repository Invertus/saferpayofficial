...
class GetPaymentPageConfigurationsService
{
    /** @var ApiRequest */
    private $apiRequest;
    ...
    /**
     * @param GetPaymentPageConfigurationsRequest $request
     * @param string $username
     * @param string $password
     * @param string $baseUrl
     * @return mixed
     */
    public function getPaymentPageConfigurations(
        GetPaymentPageConfigurationsRequest $request,
        $username,
        $password,
        $baseUrl
    ) {
