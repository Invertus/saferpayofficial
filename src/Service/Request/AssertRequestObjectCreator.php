...
class AssertRequestObjectCreator extends RequestObjectCreator
{
    /**
    ...
    public function __construct(SaferPayOrderRepository $orderRepository, SaferPayOfficial $module)
    {
