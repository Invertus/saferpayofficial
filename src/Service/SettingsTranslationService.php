...
class SettingsTranslationService
{
    ...
    private function getApiCredentialsTranslations()
    {
        return [
            ...
            'separateEmails' => $this->module->l('Separate multiple email addresses with commas.', self::FILE_NAME),
            ...
            'fieldAccessTokenPath' => $this->module->l('Settings > Saferpay Fields Access Tokens', self::FILE_NAME),
            'fieldAccessToken' => $this->module->l('Field Access Token', self::FILE_NAME),
            'enterFieldAccessToken' => $this->module->l('Enter field access token', self::FILE_NAME),
            'fieldJsUrl' => $this->module->l('Field Javascript Library URL', self::FILE_NAME),
            'businessLicense' => $this->module->l('I have Business license', self::FILE_NAME),
            'businessLicenseDescription' => $this->module->l('Enable if you have a Saferpay Business license for advanced features.', self::FILE_NAME),
        ];
    }
    ...
    private function getPaymentProcessingTranslations()
    {
        return [
            ...
            'behaviourWhen3dsFails' => $this->module->l('Behaviour when 3D Secure fails', self::FILE_NAME),
            ...
            'cardDisplaySaving' => $this->module->l('Card Display & Saving', self::FILE_NAME),
    ...
    private function getGeneralSettingsTranslations()
    {
        return [
            ...
            'configNameDescription' => $this->module->l('This name is visible in payment page and also in payment confirmation email.', self::FILE_NAME),
