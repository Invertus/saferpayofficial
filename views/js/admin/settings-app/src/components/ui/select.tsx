...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'sp-flex sp-h-10 sp-w-full sp-items-center sp-justify-between sp-rounded-md sp-border sp-border-input sp-bg-background sp-px-3 sp-py-2 sp-text-sm sp-ring-offset-background placeholder:sp-text-muted-foreground focus:sp-outline-none focus:sp-ring-2 focus:sp-ring-ring focus:sp-ring-offset-2 disabled:sp-cursor-not-allowed disabled:sp-opacity-50 [&>span]:sp-line-clamp-1',
      className,
    )}
    {...props}
  >
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal container={document.querySelector<HTMLElement>('.sp-saferpay-root')}>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('sp-py-1.5 sp-pl-8 sp-pr-2 sp-text-sm sp-font-semibold', className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'sp-relative sp-flex sp-w-full sp-cursor-default sp-select-none sp-items-center sp-rounded-sm sp-py-1.5 sp-pl-8 sp-pr-2 sp-text-sm sp-outline-none focus:sp-bg-accent focus:sp-text-accent-foreground data-[disabled]:sp-pointer-events-none data-[disabled]:sp-opacity-50',
      className,
    )}
    {...props}
  >
