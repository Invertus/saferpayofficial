...
// it('34 GOOGLEPAY Checkouting', () => { //TODO to finish, overcome the security
...
//       //     }
//       cy.wait(20000)
//       cy.iframe("#ThreeDSv2Authentication").within(() => {
...
//       //   })
//       //cy.iframe('#ThreeDSv2Authentication').find('[class="btn btn-block btn-primary"]')
